...
--
-- Name: grades; Type: TABLE; Schema: public; Owner: bdo_ani
--
...
ALTER TABLE public.grades OWNER TO bdo_ani;

--
-- Name: grades_id_seq; Type: SEQUENCE; Schema: public; Owner: bdo_ani
--
...
ALTER TABLE public.grades_id_seq OWNER TO bdo_ani;

--
-- Name: grades_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: bdo_ani
--
...
--
-- Name: grades id; Type: DEFAULT; Schema: public; Owner: bdo_ani
--
...
--
-- Data for Name: grades; Type: TABLE DATA; Schema: public; Owner: bdo_ani
--
...
--
-- Name: grades_id_seq; Type: SEQUENCE SET; Schema: public; Owner: bdo_ani
--
...
--
-- Name: grades grades_pkey; Type: CONSTRAINT; Schema: public; Owner: bdo_ani
--
...
--
-- Name: grades grades_project_title_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bdo_ani
--
...
--
-- Name: grades grades_student_github_fkey; Type: FK CONSTRAINT; Schema: public; Owner: bdo_ani
--
